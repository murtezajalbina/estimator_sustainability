...
export class PlotSingleProductComponent implements OnInit {
  ...
  private createBarChart(selectedItem: string, table: any[]): void {
    ...
    this.driveData
      .getEmissions(this.selectedItem, 'Comp. parts')
      .subscribe((data) => {
        this.emissionsCompoundparts = data;
      });
    this.driveData
      .getEmissions(this.selectedItem, 'Other metals')
      .subscribe((data) => {
        this.emissionsMetals = data;
      });
    this.driveData
      .getEmissions(this.selectedItem, 'Others')
      .subscribe((data) => {
        this.emissionsOther = data;
      });
    this.driveData
      .getEmissions(this.selectedItem, 'Steel')
      .subscribe((data) => {
